...
Tilemap Engine::createTilemap(
    const Texture& tileset, const int* tileIndices, int tilePixelWidth, int tilePixelHeight, int mapTilesWidth, int mapTilesHeight)
{
...
UI::Textlayer Engine::createTextlayer(
    const Texture& font, const char* tx, int fontPxWidth, int fontPxHeight, int maxLettersPerRow, int maxRows)
{
